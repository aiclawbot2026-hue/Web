    ...
    <div className="grid gap-6 xl:grid-cols-4">
      {dict.offers.items.map((offer) => {
        ...
        return (
          ...
          >
            <div className="absolute inset-x-0 top-0 h-1 bg-gradient-to-r from-primary via-[#7c8cff] to-accentSoft" />
            {isFeatured ? (
              <div className="mb-4 inline-flex w-fit rounded-full bg-gradient-to-r from-primary to-[#7c8cff] px-3 py-1 text-xs font-bold uppercase tracking-[0.2em] text-white shadow-[0_10px_30px_rgba(92,168,255,0.2)]">
            ...
            <div className="mt-5 grid gap-3">
              <div className="spec-chip-blue">{offer.cores}</div>
              <div className="spec-chip-violet">{offer.ram}</div>
              <div className="spec-chip-dark">{offer.storage}</div>
            </div>
      ...
      {page === "home" ? (
        <>
          <section className="relative z-10 overflow-hidden py-28 md:py-40">
            <div className="absolute inset-0 bg-[radial-gradient(circle_at_20%_20%,rgba(92,168,255,0.16),transparent_22%),radial-gradient(circle_at_80%_10%,rgba(124,140,255,0.10),transparent_18%)]" />
            <div className="section-shell relative grid min-h-[78vh] items-center gap-16 lg:grid-cols-[1.08fr_0.92fr]">
              <div>
                <div className="mb-6 inline-flex rounded-full border border-primary/30 bg-primary/10 px-4 py-2 text-sm text-primary shadow-glow backdrop-blur-md">
                  Ryzen 9 9950X3D · NVMe · Support humain
                </div>
                <h1 className="max-w-4xl text-5xl font-black leading-[0.92] text-white md:text-7xl xl:text-[5.4rem]">
                  {dict.home.title}
                </h1>
              ...
              <div className="home-panel relative overflow-hidden">
                <div className="absolute inset-0 bg-[radial-gradient(circle_at_top_right,rgba(92,168,255,0.12),transparent_26%),radial-gradient(circle_at_bottom_left,rgba(124,140,255,0.10),transparent_24%)]" />
                <div className="relative">
                  ...
                  <div className="mt-8 grid gap-4">
                    {dict.home.trustPoints.map((point) => (
                      <div key={point} className="rounded-2xl border border-white/10 bg-white/5 px-4 py-4 text-slate-200 shadow-[0_8px_24px_rgba(0,0,0,0.16)]">
                        {point}
                      </div>
                    ))}
                  </div>
          ...
          <section className="home-section">
            <div className="section-shell">
              ...
              <div className="mt-16">{offerCards}</div>
            </div>
          </section>
            ...
            <div className="section-shell">
              ...
              <div className="mt-14 grid gap-6 md:grid-cols-2 xl:grid-cols-4">
                {dict.why.items.slice(0, 4).map((item) => (
                  <div key={item.title} className="home-panel p-6 md:p-7">
                    <div className="mb-4 h-10 w-10 rounded-2xl bg-gradient-to-br from-primary/20 to-[#7c8cff]/20" />
          ...
          <section className="home-section pt-24 md:pt-28">
            <div className="section-shell">
              <div className="home-panel text-center md:p-14">
