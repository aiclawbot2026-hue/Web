  ...
  return (
    <main className="relative overflow-hidden bg-[#050b14] text-white">
        ...
        <div className="section-shell flex items-center justify-between gap-4 py-5">
          ...
          <div className="flex items-center gap-3 md:gap-5">
            <nav className="hidden gap-7 text-sm text-slate-200 md:flex">
              ...
              <a href="#support" className="hover:text-white">{dict.nav.support}</a>
      ...
      <section className="relative z-10">
        <div className="section-shell grid min-h-[84vh] items-center gap-14 py-20 md:grid-cols-[1.08fr_0.92fr] md:py-32">
          <div>
      ...
      <section id="offers" className="relative z-10 py-28">
      ...
      <section id="why" className="relative z-10 py-28">
        <div className="section-shell">
      ...
      <section id="support" className="relative z-10 py-28">
        <div className="section-shell grid gap-8 lg:grid-cols-[0.92fr_1.08fr]">
          <div>
            ...
            <h2 className="section-title mt-4">{dict.support.title}</h2>
          </div>
